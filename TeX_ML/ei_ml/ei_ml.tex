...
\begin{figure}[h]
  ...
  \caption{\label{fig:threeinctanh:11}Imaging up to 3 inclusions (twisted tanh): result 11. Both inclusions are clearly seen but their shear moduli are overpredicted. There are no regions of low shear modulus adjacent to the inclusion.}
\end{figure}
\newpage
\clearpage
% Figure 12 3inc
...
A CNN capable of predicting shear modulus fields from displacement or strain fields (or components thereof) was presented. Results inwhich a single inclusion was imaged and multiple inclusions were imaged were presented. These results warrant further research. 
