...
\begin{figure}
  ...
  %
  \begin{subfigure}[b]{\nhgscalefactor\linewidth}
    \includegraphics[totalheight=\nhgfigheight]{Figures/final/ex1/mu1.png}
    \caption{True}
  \end{subfigure}
  %
   \begin{subfigure}[b]{\nhgscalefactor\linewidth}
    \includegraphics[totalheight=\nhgfigheight]{Figures/final/ex1/mu2.png}
    \caption{$\epsilon_{xx}+\epsilon_{yy}$}
   \end{subfigure}
   %
   \begin{subfigure}[b]{\nhgscalefactor\linewidth}
    \includegraphics[totalheight=\nhgfigheight]{Figures/final/ex1/mu3.png}
    \caption{(b) + noise}
   \end{subfigure}
   %
   \begin{subfigure}[b]{\nhgscalefactor\linewidth}
    \includegraphics[totalheight=\nhgfigheight]{Figures/final/ex1/mu4.png}
    \caption{$\epsilon_{yy}$}
   \end{subfigure}
   %
   \begin{subfigure}[b]{\nhgscalefactor\linewidth}
     \includegraphics[totalheight=\nhgfigheight]{Figures/final/ex1/mu5.png}
     \caption{$\epsilon_{yy}$+noise}
   \end{subfigure}
   \begin{subfigure}[b]{\nhgscalefactor\linewidth}
     \includegraphics[totalheight=\nhgfigheight]{Figures/final/ex1/mu6.png}
     \caption{$u_x+u_y$}
   \end{subfigure}
   %
   \begin{subfigure}[b]{\nhgscalefactor\linewidth}
     \includegraphics[totalheight=\nhgfigheight]{Figures/final/ex1/mu7.png}
     \caption{$u_y$}
   \end{subfigure}
   %
   \begin{subfigure}[b]{\nhgscalefactor\linewidth}
     \includegraphics[totalheight=\nhgfigheight]{Figures/final/ex1/mu8.png}
     \caption{$u_y$+noise}
   \end{subfigure}
...
\begin{figure}
  \mupics{1}
  \caption{Testing mupics}
\end{figure}
\begin{figure}
  \mupics{1}
  \caption{Testing mupics2}
\end{figure}
\newpage
%
...
\item{Training with random data}
\item{In this work, we have only constrained the predicted shear modulus to be greater than zero. This is a basic physical constraint. Better results may be obtained if one knows the background shear modulus and uses this fact to constrain the predicted shear modulus to be greater than the background shear modulus.}
\item{It is seen that better results are obtained for larger inclusion with larger contrast. Designing a network to accurately image small inclusions will be interesting. We note that having material properties and displacements on the same mesh may lead to unconverged displacements for smaller inclusions. These unconverged displacements will not have enough features/information to be able to predict stiffness fields from them. It may be useful to make the displacement mesh much finer than the shear modulus mesh so as to resolve features created by small inclusions.}
