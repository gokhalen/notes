...
The typical architecture of the CNN we use in this work is shown in Figure (\ref{fig:typical_cnn}) and its parameters are given in Table (\ref{tab:cnnparams}). This CNN was implemented in TensorFlow \cite{misc:tensorflow}. The first dimension '?' represents the number of examples to be processed for training, validation or testing. Thus, the first training example is a three dimensional array and can be accessed using the indices $[0,:,:,:]$ (using Numpy notation) and similarly for the others. The second and third dimensions represent the number of nodes in the $y$ and $x$ direction respectively. The last dimension represents the number of channels in the image. In image-processing the number of channels is typically $3$, one channel each for the three colors red, green and blue (RGB). In our case, the number of channels is the number of independent fields in our problem. If we use three independent components of the strain field $\epsilon_{xx},\epsilon_{yy},\epsilon_{xy}$ then the number of channels is $3$. If we use only a single component of the strain field, say $\epsilon_{xx}$ only, then the number of channels is $1$. Table (\ref{tab:cnnone:io}) gives the number of channels for each CNN trained. The \textit{loss function} is \textit{mean squared error} and the optimizer is \textit{Adam}. No regularization is used.  Each CNN has approximately $3.35$ million train-able parameters. After training, the model with the best validation loss is chosen to make predictions.\\The \textit{softplus} activation function in equation (\ref{eqn:softplus}) and the \textit{twisted tanh} activation function in equation (\ref{eqn:twisttanh}) are considered in this work. The predictions made using the \textit{softplus} only respect the basic positivity constraint on the shear modulus. These results are documented in Sections (\ref{sect:oneinc}) and (\ref{sect:threeinc}). It is seen that the CNNs tend to predict regions of low shear modulus surround the inclusions. Therefore we seek to restrict the range of the shear modulus predicted by the CNN to within known limits $[\mu_{back},\mu_{max}]$. One can simply do this by thresholdingh: just apply \textit{min} and \textit{max} functions to post-process the result. But this is unsatisfying. We first applied a suitable scaling to change the range of the output variable from $[\mu_{back},\mu_{max}]$ to $(0,1)$ or $(-1,1)$ as appropriate. We then considered the use of activation functions given in equations (\ref{eqn:sigmoid},\ref{eqn:tanh},\ref{eqn:softplusmin}) whose range is restricted to $(0,1),(-1,1)$ and $(0,1)$. As noted in \cite{bookchap:lecun98b} we observed that with the activation functions given in equations (\ref{eqn:sigmoid},\ref{eqn:tanh},\ref{eqn:softplusmin}) the weights and therefore loss function become stuck because the derivatives of equations (\ref{eqn:sigmoid},\ref{eqn:tanh},\ref{eqn:softplusmin}) become very zero for values sufficiently away from zero. However, we observe, as noted in \cite{bookchap:lecun98b}, that the addition of a 'twisting term' ($0.01x$) to the $\tanh(x)$ function makes the derivative non-zero and the CNN begins to train again. The penalty that we pay, is that the output is only approximately (not exactly) restricted to the range $[\mu_{back},\mu_{max}]$. 
\begin{subequations}
\ber
...
\begin{figure}[h]
  ...
  \caption{\label{fig:oneinc:1}Imaging one inclusion (softplus): result 1. These results show that the shear modulus of small inclusions is underpredicted. Result (d) is more accurate than result (a) inspite of using only $\epsilon_{yy}$. There are areas of low shear modulus adjacent to the inclusion especially in figures (b) and (c).}
\end{figure}
\newpage
\clearpage
% Figure 1 (onetanh)
\begin{figure}[h]
  ...
  \caption{\label{fig:oneinctanh:1}Imaging one inclusion (twisted tanh): result 1.}
\end{figure}
\newpage
\clearpage
% Figure 2 (softplus)
...
\begin{figure}[h]
  ...
  \caption{\label{fig:oneinctanh:2}Imaging one inclusion (twisted tanh): result 2.}
\end{figure}
\newpage
\clearpage
% Figure 3 (softplus)
...
\begin{figure}[h]
  ...
  \caption{\label{fig:oneinctanh:3}Imaging one inclusion (twisted tanh): result 3.}
\end{figure}
\newpage
\clearpage
% Figure 4 (softplus)
...
\begin{figure}[h]
  ...
  \caption{\label{fig:oneinctanh:4}Imaging one inclusion (twisted tanh): result 4.}
\end{figure}
\newpage
\clearpage
% Figure 5 (softplus)
\begin{figure}[h]
  ...
  \caption{\label{fig:oneinc:5}Imaging one inclusion (softplus): result 5. Shear modulus of medium sized inclusion seems to be predicted reasobably accurately. There are areas of low shear modulus adjacent to the inclusion especially in figures (b) and (c).}
\end{figure}
\newpage
\clearpage
% Figure 5 (onetanh)
\begin{figure}[h]
  ...
  \caption{\label{fig:oneinctanh:5}Imaging one inclusion (twisted tanh): result 5.}
\end{figure}
\newpage
\clearpage
% Figure 6 (softplus)
\begin{figure}[h]
  ...
  \caption{\label{fig:oneinc:6}Imaging one inclusion (softplus): result 6. Shear modulus of small inclusions is severely underpredicted.}
\end{figure}
\newpage
\clearpage
% Figure 6 (onetanh)
\begin{figure}[h]
  ...
  \caption{\label{fig:oneinctanh:6}Imaging one inclusion (twisted tanh): result 6.}
\end{figure}
\newpage
\clearpage
% Figure 7 (softplus)
\begin{figure}[h]
  ...
  \caption{\label{fig:oneinc:7}Imaging one inclusion (softplus): result 7. Shear modulus of this inclusion is slightly overpredicted. There are areas of low shear modulus adjacent to the inclusion especially in figures (b),(c),(g) and (h).}
\end{figure}
\newpage
\clearpage
% Figure 7 (onetanh)
\begin{figure}[h]
  ...
  \caption{\label{fig:oneinctanh:7}Imaging one inclusion (twisted tanh): result 7.}
\end{figure}
\newpage
\clearpage
% Figure 8 (softplus)
\begin{figure}[h]
  ...
  \caption{\label{fig:oneinc:8}Imaging one inclusion (softplus): result 8. Shear modulus of this small inclusion is severely underpredicted.}
\end{figure}
\newpage
\clearpage
% Figure 8 (onetanh)
\begin{figure}[h]
  ...
  \caption{\label{fig:oneinctanh:8}Imaging one inclusion (twisted tanh): result 8.}
\end{figure}
\newpage
\clearpage
% Figure 9 (softplus)
\begin{figure}[h]
  ...
  \caption{\label{fig:oneinc:9}Imaging one inclusion (softplus): result 9. There appear to be patches of low shear modulus around the predicted inclusions in all reconstructions.}
\end{figure}
\newpage
\clearpage
% Figure 9 (onetanh)
\begin{figure}[h]
  ...
  \caption{\label{fig:oneinctanh:9}Imaging one inclusion (twisted tanh): result 9.}
\end{figure}
\newpage
\clearpage
% Figure 10 (softplus)
...
\begin{figure}[h]
  ...
  \caption{\label{fig:oneinctanh:10}Imaging one inclusion (twisted tanh): result 10.}
\end{figure}
\newpage
\clearpage
% Figure 11 (softplus)
\begin{figure}[h]
  ...
  \caption{\label{fig:oneinc:11}Imaging one inclusion (softplus): result 11. Inclusions to the side of the domain seem to be detected fairly well. All the results, especially (b) and (c), show regions of low shear modulus adjacent to regions of high shear modulus.}
\end{figure}
\newpage
\clearpage
% Figure 11 (onetanh)
\begin{figure}[h]
  ...
  \caption{\label{fig:oneinctanh:11}Imaging one inclusion (twisted tanh): result 11.}
\end{figure}
\newpage
\clearpage
% Figure 12 (softplus)
...
\begin{figure}[h]
  ...
  \caption{\label{fig:oneinctanh:12}Imaging one inclusion (twisted tanh): result 12.}
\end{figure}
\newpage
\clearpage
% Figure 13 (softplus)
...
\begin{figure}[h]
  ...
  \caption{\label{fig:oneinctanh:13}Imaging one inclusion (twisted tanh): result 13.}
\end{figure}
\newpage
\clearpage
% Figure 14 (softplus)
...
\begin{figure}[h]
  ...
  \caption{\label{fig:oneinctanh:14}Imaging one inclusion (twisted tanh): result 14.}
\end{figure}
\newpage
\clearpage
% Figure 15 (softplus)
\begin{figure}[h]
  ...
  \caption{\label{fig:oneinc:15}Imaging one inclusion (softplus): result 15. Medium sized inclusions are detected fairly well. Surprisingly the best reconstruction is obtained in (d) where only $\epsilon_{yy}$ is used. }
\end{figure}
\newpage
\clearpage
% Figure 15 (onetanh)
\begin{figure}[h]
  ...
  \caption{\label{fig:oneinctanh:15}Imaging one inclusion (twisted tanh): result 15.}
\end{figure}
\newpage
\clearpage
% Figure 16 (softplus)
...
\begin{figure}[h]
  ...
  \caption{\label{fig:oneinctanh:16}Imaging one inclusion (twisted tanh): result 16.}
\end{figure}
\newpage
\clearpage
%
...
\begin{figure}[h]
  ...
  \end{subfigure}
  %
\caption{\label{fig:oneinc:trainexxeyy3} Training curves for CNN $\epsilon_{xx}$ \& $\epsilon_{yy}$ for imaging up to 3 inclusions.}
\end{figure}
...
\begin{figure}[h]
  ...
  \end{subfigure}
  %
\caption{\label{fig:oneinc:traineyy3} Training curves for CNN $\epsilon_{yy}$ for imaging up to 3 inclusions.}
\end{figure} 
...
\begin{figure}[h]
  ...
  \end{subfigure}
  %
  \caption{\label{fig:oneinc:trainuxuy3} Training curves for CNN $u_x$ \& $u_y$ for imaging up to 3 inclusions.}
\end{figure}
...
\begin{figure}[h]
  ...
  \end{subfigure}
  %
  \caption{\label{fig:oneinc:trainuy3} Training curves for CNN $u_y$ for imaging up to 3 inclusions.}
\end{figure}
%
% Figure 1
\begin{figure}[h]
  \mupics{3}{1}{fig:threeinc:1}
  \caption{\label{fig:threeinc:1}Imaging up to 3 inclusions: result 1.}
\end{figure}
\newpage
\clearpage
% Figure 2
\begin{figure}[h]
  ...
  \caption{\label{fig:threeinc:2}Imaging up to 3 inclusions: result 2. }
\end{figure}
\newpage
\clearpage
% Figure 3
\begin{figure}[h]
  ...
  \caption{\label{fig:threeinc:3}Imaging up to 3 inclusions: result 3. }
\end{figure}
\newpage
\clearpage
% Figure 4
\begin{figure}[h]
  ...
  \caption{\label{fig:threeinc:4}Imaging up to 3 inclusions: result 4. }
\end{figure}
\newpage
\clearpage
% Figure 5
\begin{figure}[h]
  ...
  \caption{\label{fig:threeinc:5}Imaging up to 3 inclusions: result 5. }
\end{figure}
\newpage
\clearpage
% Figure 6
\begin{figure}[h]
  ...
  \caption{\label{fig:threeinc:6}Imaging up to 3 inclusions: result 6. }
\end{figure}
\newpage
\clearpage
% Figure 7
\begin{figure}[h]
  ...
  \caption{\label{fig:threeinc:7}Imaging up to 3 inclusions: result 7. }
\end{figure}
\newpage
\clearpage
% Figure 8
\begin{figure}[h]
  ...
  \caption{\label{fig:threeinc:8}Imaging up to 3 inclusions: result 8. }
\end{figure}
\newpage
\clearpage
% Figure 9
\begin{figure}[h]
  ...
  \caption{\label{fig:threeinc:9}Imaging up to 3 inclusions: result 9. }
\end{figure}
\newpage
\clearpage
% Figure 10
\begin{figure}[h]
  ...
  \caption{\label{fig:threeinc:10}Imaging up to 3 inclusions: result 10. }
\end{figure}
\newpage
\clearpage
% Figure 11
\begin{figure}[h]
  ...
  \caption{\label{fig:threeinc:11}Imaging up to 3 inclusions: result 11. }
\end{figure}
\newpage
\clearpage
% Figure 12
\begin{figure}[h]
  \mupics{3}{12}{}
  \caption{\label{fig:threeinc:12}Imaging up to 3 inclusions: result 12. }
\end{figure}
\newpage
\clearpage
% Figure 13
\begin{figure}[h]
  ...
  \caption{\label{fig:threeinc:13}Imaging up to 3 inclusions: result 13. }
\end{figure}
\newpage
\clearpage
% Figure 14
\begin{figure}[h]
  ...
  \caption{\label{fig:threeinc:14}Imaging up to 3 inclusions: result 14. }
\end{figure}
\newpage
\clearpage
% Figure 15
\begin{figure}[h]
  ...
  \caption{\label{fig:threeinc:15}Imaging up to 3 inclusions: result 15. }
\end{figure}
\newpage
\clearpage
% Figure 16
\begin{figure}[h]
  ...
  \caption{\label{fig:threeinc:16}Imaging up to 3 inclusions: result 16. }
\end{figure}
\newpage
\clearpage
%
...
\section{Imaging three inclusions with constraints}
% Training loss, val_loss for exxeyy
\begin{figure}[h]
  %
  \centering
...
\end{figure}
%
% Training loss, val_loss for ux+uy
\begin{figure}[h]
  %
  \centering
  \begin{subfigure}[b]{0.45\linewidth}
...
\begin{figure}[h]
  ...
  \caption{\label{fig:threeinctanh:1}Imaging three inclusions with constraints: result 1.}
\end{figure}
\newpage
\clearpage
% Figure 2 (threetanh)
\begin{figure}[h]
  ...
  \caption{\label{fig:threeinctanh:2}Imaging three inclusions with constraints: result 2.}
\end{figure}
\newpage
\clearpage
% Figure 3 (threetanh)
\begin{figure}[h]
  ...
  \caption{\label{fig:threeinctanh:3}Imaging three inclusions with constraints: result 3.}
\end{figure}
\newpage
\clearpage
% Figure 4 (threetanh)
\begin{figure}[h]
  ...
  \caption{\label{fig:threeinctanh:4}Imaging three inclusions with constraints: result 4.}
\end{figure}
\newpage
\clearpage
% Figure 5 (threetanh)
\begin{figure}[h]
  ...
  \caption{\label{fig:threeinctanh:5}Imaging three inclusions with constraints: result 5.}
\end{figure}
\newpage
\clearpage
% Figure 6 (threetanh)
\begin{figure}[h]
  ...
  \caption{\label{fig:threeinctanh:6}Imaging three inclusions with constraints: result 6.}
\end{figure}
\newpage
\clearpage
% Figure 7 (threetanh)
\begin{figure}[h]
  ...
  \caption{\label{fig:threeinctanh:7}Imaging three inclusions with constraints: result 7.}
\end{figure}
\newpage
\clearpage
% Figure 8 (threetanh)
\begin{figure}[h]
  ...
  \caption{\label{fig:threeinctanh:8}Imaging three inclusions with constraints: result 8.}
\end{figure}
\newpage
\clearpage
% Figure 9 (threetanh)
\begin{figure}[h]
  ...
  \caption{\label{fig:threeinctanh:9}Imaging three inclusions with constraints: result 9.}
\end{figure}
\newpage
\clearpage
% Figure 10 (threetanh)
\begin{figure}[h]
  ...
  \caption{\label{fig:threeinctanh:10}Imaging three inclusions with constraints: result 10.}
\end{figure}
\newpage
\clearpage
% Figure 11 (threetanh)
\begin{figure}[h]
  ...
  \caption{\label{fig:threeinctanh:11}Imaging three inclusions with constraints: result 11.}
\end{figure}
\newpage
\clearpage
% Figure 12 (threetanh)
\begin{figure}[h]
  ...
  \caption{\label{fig:threeinctanh:12}Imaging three inclusions with constraints: result 12.}
\end{figure}
\newpage
\clearpage
% Figure 13 (threetanh)
\begin{figure}[h]
  ...
  \caption{\label{fig:threeinctanh:13}Imaging three inclusions with constraints: result 13.}
\end{figure}
\newpage
\clearpage
% Figure 14 (threetanh)
\begin{figure}[h]
  ...
  \caption{\label{fig:threeinctanh:14}Imaging three inclusions with constraints: result 14.}
\end{figure}
\newpage
\clearpage
% Figure 15 (threetanh)
\begin{figure}[h]
  ...
  \caption{\label{fig:threeinctanh:15}Imaging three inclusions with constraints: result 15.}
\end{figure}
\newpage
\clearpage
% Figure 16 (threetanh)
\begin{figure}[h]
  ...
  \caption{\label{fig:threeinctanh:16}Imaging three inclusions with constraints: result 16.}
\end{figure}
\newpage
\clearpage
