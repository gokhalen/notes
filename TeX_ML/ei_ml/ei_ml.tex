...
\ber
\label{eqn:varacts}
f(x) = \mu_{max}\frac{1}{1+\exp(-x)} + \mu_{back}\\
f(x) = \tanh(x) \\
f(x) = \min(\ln(1+\exp(x)) + \mu_{back},\mu_{max})
\eer
\begin{table}
  \centering
 \begin{tabular}{|c|c|}
...
\begin{table}
  ...
  \begin{tabular}{|l|l|c|c|c|}
    ...
    \hline
    1 & CNN $\epsilon_{xx}$ \& $\epsilon_{yy}$ & $\epsilon_{xx}$ \& $\epsilon_{yy}$ & $\epsilon_{xx}$ \& $\epsilon_{yy}$ or $\epsilon_{xx}$ \& $\epsilon_{yy}$ + noise & 2\\
    \hline
    2 & CNN $\epsilon_{yy}$ & $\epsilon_{yy}$ & $\epsilon_{yy}$ or $\epsilon_{yy}$ + noise & 1\\
    \hline
    3 & CNN $u_x$ \& $u_y$ & $u_x$ \& $u_y$ & $u_x$ \& $u_y$ & 2\\
    \hline
    4 & CNN $u_y$ & $u_y$ & $u_y$ or $u_y$ + noise& 1\\
    \hline
    5 & CNNc $\epsilon_{xx}$ \& $\epsilon_{yy}$ & $\epsilon_{xx}$ \& $\epsilon_{yy}$ & $\epsilon_{xx}$ \& $\epsilon_{yy}$ or $\epsilon_{xx}$ \& $\epsilon_{yy}$ + noise & 2\\
    \hline
    6 & CNNc $\epsilon_{yy}$ & $\epsilon_{yy}$ & $\epsilon_{yy}$ or $\epsilon_{yy}$ + noise & 1\\
    \hline
    7 & CNNc $u_x$ \& $u_y$ & $u_x$ \& $u_y$ & $u_x$ \& $u_y$ & 2\\
    \hline
    8 & CNNc $u_y$ & $u_y$ & $u_y$ or $u_y$ + noise & 1\\
    \hline
  \end{tabular}
  \caption{\label{tab:cnnone:io} Listing of CNNs trained, their training and prediction data. The first $4$ CNNs only have the constraint the $\mu>0$. The last $4$ CNNs are constraind to predict between $\mu_{back}=1.0$ and $\mu_{max}=5.0$. The 'c' in 'CNNc' stands for 'constrained'. These CNNs are trained for with data containing only one inclusion and with data containing up to three inclusions. Thus a total of 16 CNNs are trained.}
\end{table}
%
\begin{table}
  \centering
...
\end{table}
\section{Imaging one inclusion with constraints}
% Training loss, val_loss for exxeyy
\begin{figure}[h]
  %
  \centering
  ...
  \end{subfigure}
  %
\caption{\label{fig:oneinctanh:trainexxeyy} Training and validation loss for CNNc $\epsilon_{xx}$ \& $\epsilon_{yy}$ for imaging one inclusion with constraints.}
\end{figure}
% Training loss, val_loss for eyy
\begin{figure}[h]
  %
  ...
  \end{subfigure}
  %
\caption{\label{fig:oneinctanh:traineyy} Training and validation loss for CNNc $\epsilon_{yy}$ for imaging one inclusion with constraints.}
\end{figure}
%
...
\begin{figure}[h]
  ...
  \end{subfigure}
  %
\caption{\label{fig:oneinctanh:trainuxuy} Training and validation loss for CNNc $u_x$ \& $u_y$ for imaging one inclusion with constraints.}
\end{figure}
%
% Training loss, val_loss for uy
\begin{figure}[h]
  ...
  \end{subfigure}
  %
\caption{\label{fig:oneinctanh:trainuy} Training and validation loss for CNNc $u_y$ for imaging one inclusion with constraints.}
\end{figure}
% Figure 1 (onetanh)
\begin{figure}[h]
  \mupics{1c}{1}{fig:oneinctanh:1}
  \caption{\label{fig:oneinctanh:1}Imaging one inclusion with constraints: result 1.}
\end{figure}
\newpage
\clearpage
% Figure 2 (onetanh)
\begin{figure}[h]
  ...
  \caption{\label{fig:oneinctanh:2}Imaging one inclusion with constraints: result 2.}
\end{figure}
\newpage
\clearpage
% Figure 3 (onetanh)
\begin{figure}[h]
  ...
  \caption{\label{fig:oneinctanh:3}Imaging one inclusion with constraints: result 3.}
\end{figure}
\newpage
\clearpage
% Figure 4 (onetanh)
\begin{figure}[h]
  ...
  \caption{\label{fig:oneinctanh:4}Imaging one inclusion with constraints: result 4.}
\end{figure}
\newpage
\clearpage
% Figure 5 (onetanh)
\begin{figure}[h]
  ...
  \caption{\label{fig:oneinctanh:5}Imaging one inclusion with constraints: result 5.}
\end{figure}
\newpage
\clearpage
% Figure 6 (onetanh)
\begin{figure}[h]
  ...
  \caption{\label{fig:oneinctanh:6}Imaging one inclusion with constraints: result 6.}
\end{figure}
\newpage
\clearpage
% Figure 7 (onetanh)
\begin{figure}[h]
  ...
  \caption{\label{fig:oneinctanh:7}Imaging one inclusion with constraints: result 7.}
\end{figure}
\newpage
\clearpage
% Figure 8 (onetanh)
\begin{figure}[h]
  ...
  \caption{\label{fig:oneinctanh:8}Imaging one inclusion with constraints: result 8.}
\end{figure}
\newpage
\clearpage
% Figure 9 (onetanh)
\begin{figure}[h]
  ...
  \caption{\label{fig:oneinctanh:9}Imaging one inclusion with constraints: result 9.}
\end{figure}
\newpage
\clearpage
% Figure 10 (onetanh)
\begin{figure}[h]
  ...
  \caption{\label{fig:oneinctanh:10}Imaging one inclusion with constraints: result 10.}
\end{figure}
\newpage
\clearpage
% Figure 11 (onetanh)
\begin{figure}[h]
  ...
  \caption{\label{fig:oneinctanh:11}Imaging one inclusion with constraints: result 11.}
\end{figure}
\newpage
\clearpage
% Figure 12 (onetanh)
\begin{figure}[h]
  ...
  \caption{\label{fig:oneinctanh:12}Imaging one inclusion with constraints: result 12.}
\end{figure}
\newpage
\clearpage
% Figure 13 (onetanh)
\begin{figure}[h]
  ...
  \caption{\label{fig:oneinctanh:13}Imaging one inclusion with constraints: result 13.}
\end{figure}
\newpage
\clearpage
% Figure 14 (onetanh)
\begin{figure}[h]
  ...
  \caption{\label{fig:oneinctanh:14}Imaging one inclusion with constraints: result 14.}
\end{figure}
\newpage
\clearpage
% Figure 15 (onetanh)
\begin{figure}[h]
  ...
  \caption{\label{fig:oneinctanh:15}Imaging one inclusion with constraints: result 15.}
\end{figure}
\newpage
\clearpage
% Figure 16 (onetanh)
\begin{figure}[h]
  ...
  \caption{\label{fig:oneinctanh:16}Imaging one inclusion with constraints: result 16.}
\end{figure}
\newpage
\clearpage
...
\begin{figure}[h]
  ...
  \end{subfigure}
  %
\caption{\label{fig:threeinctanh:trainexxeyy} Training and validation loss for CNNc $\epsilon_{xx}$ \& $\epsilon_{yy}$ for imaging three inclusions with constraints.}
\end{figure}
% Training loss, val_loss for eyy
\begin{figure}[h]
  %
  ...
  \end{subfigure}
  %
\caption{\label{fig:threeinctanh:traineyy} Training and validation loss for CNNc $\epsilon_{yy}$ for imaging three inclusions with constraints.}
\end{figure}
%
% Training loss, val_loss for ux+uy
\begin{figure}[h]
  ...
  \end{subfigure}
  %
\caption{\label{fig:threeinctanh:trainuxuy} Training and validation loss for CNNc $u_x$ \& $u_y$ for imaging three inclusions with constraints.}
\end{figure}
%
% Training loss, val_loss for uy
\begin{figure}[h]
  ...
  \end{subfigure}
  %
\caption{\label{fig:threeinctanh:trainuy} Training and validation loss for CNNc $u_y$ for imaging three inclusions with constraints.}
\end{figure}
% Figure 1 (threetanh)
\begin{figure}[h]
