...
%
The training and validation losses for CNN1 are shown in figure (\ref{fig:cnn1losses}). For this network, the total scaled error defined in equation (\ref{eqn:averagescalederror}) is $0.207$. The standard deviation of the scaled error defined in equation (\ref{eqn:averagescalederror}) is $0.0531$. Figures (\ref{fig:cnn1resultb}-\ref{fig:cnn1resultd}) show that the regions of low shear modulus are not accurately reconstructed. Their reconstruction can be best described as 'wisps'. Figure (\ref{fig:cnn1histo}) shows histograms in which the scaled error, equation (\ref{eqn:scalederror}), is on the x-axis and the y-axis represent the fraction of examples in each bin (number of examples in each bin divided by the total number of examples). It is seen that the examples appear to be normally distributed around a mean of $\approx{0.2}$ and that $80\%$ examples have scaled error of less than $0.25$.
% Losses for CNN1
\begin{figure}[!h]
  \centering
...
The training and validation losses for CNN1 are shown in figure (\ref{fig:cnn2losses}). For this network, the scaled error defined in equation (\ref{eqn:averagescalederror}) is $XXX$.
% Losses for CNN2
\begin{figure}[!h]
  \centering
  \begin{subfigure}[c]{0.45\linewidth}
...
The training and validation losses for CNN1 are shown in figure (\ref{fig:cnn3losses}). For this network, the scaled error defined in equation (\ref{eqn:averagescalederror}) is $XXX$.
% Losses for CNN3
\begin{figure}[!h]
  \centering
  \begin{subfigure}[c]{0.45\linewidth}
