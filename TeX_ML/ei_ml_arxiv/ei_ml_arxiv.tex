...
\begin{figure}[!h]
  ...
  \begin{subfigure}[c]{0.4\linewidth}
    \includegraphics[totalheight=3cm]{Figures/Results1/ex1/mu.png}
    \subcaption{\label{fig:cnn1resulta}Best (0.0786)}
  \end{subfigure}
  %
  \begin{subfigure}[c]{0.4\linewidth}
    \includegraphics[totalheight=3cm]{Figures/Results1/ex2/mu.png}
    \subcaption{\label{fig:cnn1resultb}Worst (0.391)}
  \end{subfigure}
  %
  \begin{subfigure}[c]{0.4\linewidth}
    \includegraphics[totalheight=3cm]{Figures/Results1/ex3/mu.png}
    \subcaption{\label{fig:cnn1resultc}(0.286)}
  \end{subfigure}
  %
  \begin{subfigure}[c]{0.4\linewidth}
    \includegraphics[totalheight=3cm]{Figures/Results1/ex4/mu.png}
...
\begin{figure}[!h]
  \centering
  \begin{subfigure}[c]{0.4\linewidth}
    \includegraphics[totalheight=3cm]{Figures/Results2/ex1/mu.png}
    \subcaption{\label{fig:cnn2resulta}Best (0.0972)}
  \end{subfigure}
  %
  \begin{subfigure}[c]{0.4\linewidth}
    \includegraphics[totalheight=3cm]{Figures/Results2/ex2/mu.png}
    \subcaption{\label{fig:cnn2resultb}Worst (0.494)}
  \end{subfigure}
  %
  \begin{subfigure}[c]{0.4\linewidth}
    \includegraphics[totalheight=3cm]{Figures/Results2/ex3/mu.png}
    \subcaption{\label{fig:cnn2resultc}(0.308)}
  \end{subfigure}
  %
  \begin{subfigure}[c]{0.4\linewidth}
    \includegraphics[totalheight=3cm]{Figures/Results2/ex4/mu.png}
    \subcaption{\label{fig:cnn2resultd}(0.278)}
  \end{subfigure}
...
\begin{figure}[!h]
  \centering
  \begin{subfigure}[c]{0.4\linewidth}
    \includegraphics[totalheight=3cm]{Figures/Results3/ex1/mu.png}
    \subcaption{\label{fig:cnn3resulta}Best (0.0769)}
  \end{subfigure}
  %
  \begin{subfigure}[c]{0.4\linewidth}
    \includegraphics[totalheight=3cm]{Figures/Results3/ex2/mu.png}
    \subcaption{\label{fig:cnn3resultb}Worst (0.497)}
  \end{subfigure}
  %
  \begin{subfigure}[c]{0.4\linewidth}
    \includegraphics[totalheight=3cm]{Figures/Results3/ex3/mu.png}
    \subcaption{\label{fig:cnn3resultc}(0.397)}
  \end{subfigure}
  %
  \begin{subfigure}[c]{0.4\linewidth}
    \includegraphics[totalheight=3cm]{Figures/Results3/ex4/mu.png}
