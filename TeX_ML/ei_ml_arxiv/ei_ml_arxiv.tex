...
\begin{figure}[h]
  ...
  \end{subfigure}
  %
\caption{\label{fig:activations} Activation functions for equations (\ref{eqn:softplus}-\ref{eqn:twisttanh}).}
\end{figure}
%
\begin{table}
 \centering
