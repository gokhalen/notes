...
\begin{document}
% bib
\title{Elasticity imaging using Convolutional Neural Networks}
...
\begin{figure}[!h]
  ...
  \end{subfigure}
\caption{\label{fig:app1result} Additional results for CNN1 in increasing order of the scaled error as defined in equation (\ref{eqn:scalederror}).}  
\end{figure}
%
...
\begin{figure}[!h]
  ...
  \end{subfigure}
\caption{\label{fig:app2result} Additional results for CNN2 in increasing order of the scaled error as defined in equation (\ref{eqn:scalederror}).}  
\end{figure}
%
...
\begin{figure}[!h]
  ...
  \end{subfigure}
\caption{\label{fig:app3result} Additional results for CNN3 in increasing order of the scaled error as defined in equation (\ref{eqn:scalederror}).}  
\end{figure}
%
\end{appendices}
\clearpage
