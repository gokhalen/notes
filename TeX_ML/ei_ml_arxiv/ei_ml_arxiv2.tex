...
Figure (\ref{fig:cnn_arch}) shows the architecture and parameters of the CNN we use in this work. We implement \cite{misc:mlscripts} this architecture in TensorFlow \cite{misc:tensorflow}. This architecture is essentially the same the one used in the deep learning example in \cite{misc:udemy} in which it was used to classify images into two categories: 'cat' or 'dog'.
...
\captionof{figure}{CNN architecture used in this work. This figure was generated using \url{https://github.com/gwding/draw_convnet}.}
\vfill
\end{landscape}
%
