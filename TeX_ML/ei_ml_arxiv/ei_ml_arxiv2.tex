...
\item{An encoder decoder style network consisting of Conv2D layers in the encoder (similar to the convolutional layers in the current network) and a decoder network consisting of Conv2DTranspose layers will be interesting, because it will avoid the parameter explosion caused by the final dense layers.}  
\end{enumerate}
\clearpage
\newpage
\begin{appendices}
