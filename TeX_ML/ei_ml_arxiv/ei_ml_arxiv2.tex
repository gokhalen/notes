...
We observe encouraging results with good agreement between the true and predicted shear shear modulus images. Table (\ref{table:cnnstatsummary}) summarizes the performance of the three CNNs evaluated in this work. The shear modulus of inclusions is under-predicted. The shear modulus of inclusions with low shear modulus and small size is significantly under-predicted, resulting in predictions that can be best described as \textit{wisps}.
