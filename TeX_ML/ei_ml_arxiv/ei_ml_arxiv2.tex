...
%
The training and validation losses for CNN1 are shown in figure (\ref{fig:cnn1losses}). The average inclusion scaled error given in equation (\ref{eqn:averageincscalederror}) is $-0.165$ and the average background scaled error given in equation (\ref{eqn:averagebackscalederror}) is $-0.0215$. These indicate that, on average, the shear modulus of the inclusions is under-predicted. The background, on average, is predicted accurately.

Reconstructions are shown in figure (\ref{fig:cnn1result}). Figure (\ref{fig:cnn1resulta}) is our best result according to equation (\ref{eqn:scalederror}), even though it is not visually appealing. Since the inclusion is small and the background is predicted accurately, the scaled error metric, equation (\ref{eqn:scalederror}), is not sensitive to the fact that the inclusion is not predicted accurately. The location of the inclusion is predicted accurately while the shear modulus is under-predicted. In general, the shear modulus of inclusions of low shear modulus and small size is under-predicted. This is a theme in our results. Their reconstruction can be best described as 'wisps'. Figure (\ref{fig:cnn1resultb}) is our worst reconstruction and inclusions are completely missed. In figures (\ref{fig:cnn1resultc}) and (\ref{fig:cnn1resultd}) the location of multiple inclusions is predicted accurately but there is slight error in the shear modulus. We present additional supporting results in figure (\ref{fig:app1result}) in Appendix (\ref{sect:appendix1}).
...
\begin{figure}[!h]
  ...
  \begin{subfigure}[c]{\nhgcnnwidth}
    \centering
    \includegraphics[totalheight=\nhgcnnheight]{Figures/Results1New/ex1/mu.png}
    \subcaption{\label{fig:cnn1resulta}Best (0.706)}
  \end{subfigure}
  %
  \begin{subfigure}[c]{\nhgcnnwidth}
    \centering
    \includegraphics[totalheight=\nhgcnnheight]{Figures/Results1New/ex2/mu.png}
    \subcaption{\label{fig:cnn1resultb}Worst (0.477)}
  \end{subfigure}
  %
  \begin{subfigure}[c]{\nhgcnnwidth}
    \centering
    \includegraphics[totalheight=\nhgcnnheight]{Figures/Results1New/ex3/mu.png}
    \subcaption{\label{fig:cnn1resultc} (0.298)}
  \end{subfigure}
  %
  \begin{subfigure}[c]{\nhgcnnwidth}
    \centering
    \includegraphics[totalheight=\nhgcnnheight]{Figures/Results1New/ex4/mu.png}
    \subcaption{\label{fig:cnn1resultd} (0.247)}
  \end{subfigure}
...
\end{figure}
%
\subsection{\label{sect:lexample} Cross shaped example}
