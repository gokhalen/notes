...
\begin{table}
  ...
  \begin{tabular}{|c|c|c|c|}
    ...
    softplus                 &        &             & \\
    \hline
    twisted tanh $[0.5, 5.5]$  &        &           & \\     
    \hline
    twisted tanh $[0.75,5.25]$ &         &           &\\
    \hline
    twisted tanh $[1.0, 5.0]$  &         &           & \\
    \hline
  \end{tabular}
...
\begin{figure}[!h]
  ...
  \begin{subfigure}[c]{\nhghaloeswidth}
  \centering    
    \includegraphics[totalheight=\nhghaloesheight]{Figures/dummy.png}
...
%
The training and validation losses for CNN1 are shown in figure (\ref{fig:cnn1losses}). The average inclusion scaled error is \red{XXX} and the average background scaled error is \red{XXX}. These indicate that, on average, the shear modulus of the inclusions is under-predicted. The background, on average, is predicted accurately.
...
Figure (\ref{fig:cnn1histo}) shows histograms in which the scaled error, given in equation (\ref{eqn:scalederror}), is on the x-axis and the y-axis represents the fraction of examples in each bin (number of examples in each bin divided by the total number of examples). We see that the examples appear to be normally distributed around a mean of \red{XXX} with standard deviation \red{XXX} and that \red{XXX} test examples have scaled error of less than \red{XXX}. The maximum and minimum shear moduli in the prediction are \red{XXX} and \red{XXX} as opposed to the true values of $5.0$ and $1.0$. 
% Losses for CNN1
\begin{figure}[!h]
  \centering
  \begin{subfigure}[c]{\nhghalfwidth}
    \centering
    \includegraphics[totalheight=\nhgtotalheight]{Figures/dummy.png}
    \subcaption{Loss}
  \end{subfigure}
%  
  \begin{subfigure}[c]{\nhghalfwidth}
...
\begin{figure}[!h]
  ...
  \begin{subfigure}[c]{\nhghalfwidth}
    \centering
    \includegraphics[totalheight=\nhgtotalheight]{Figures/dummy.png}
    \subcaption{\label{fig:cnn1resulta}Best }
  \end{subfigure}
  %
  \begin{subfigure}[c]{\nhghalfwidth}
    \centering
    \includegraphics[totalheight=\nhgtotalheight]{Figures/dummy.png}
    \subcaption{\label{fig:cnn1resultb}Worst }
  \end{subfigure}
  %
  \begin{subfigure}[c]{\nhghalfwidth}
    \centering
    \includegraphics[totalheight=\nhgtotalheight]{Figures/dummy.png}
    \subcaption{\label{fig:cnn1resultc}}
  \end{subfigure}
  %
  \begin{subfigure}[c]{\nhghalfwidth}
    \centering
    \includegraphics[totalheight=\nhgtotalheight]{Figures/dummy.png}
    \subcaption{\label{fig:cnn1resultd}}
  \end{subfigure}
...
The training and validation losses for CNN1 are shown in figure (\ref{fig:cnn2losses}). The average inclusion scaled error is \red{XXX} and the average background scaled error is \red{XXX}. These indicate that, on average, the shear modulus of the inclusions is under-predicted. The background, on average, is predicted accurately.

Figure (\ref{fig:cnn2resulta}) is our best result and shows accurate shear modulus and location prediction. In figure (\ref{fig:cnn2resultb}), the location of the inclusions is detected accurately, but not their shear modulus. As in section (\ref{sect:resultscnn1}), figures (\ref{fig:cnn2resultb}-\ref{fig:cnn2resultd}) show that the inclusions having low shear modulus or small size are not accurately reconstructed. Comparing figures (\ref{fig:cnn1resultc}) and (\ref{fig:cnn1resultd}) with figures (\ref{fig:cnn2resultc}) and (\ref{fig:cnn2resultd}) it appears that the displacement based neural network CNN2 is better at reconstructing inclusions of small size and low shear modulus than the strain based network CNN1. We present supporting evidence for this in section (\ref{sect:discussion}). Finally, we present additional results illustrating the performance of the network in figure (\ref{fig:app2result}) in Appendix (\ref{sect:appendix1}).

As described before in section (\ref{sect:resultscnn1}), figure (\ref{fig:cnn2histo}) shows histograms of the scaled error. We see that the examples appear to be normally distributed around a mean of \red{XXX} with standard deviation of \red{XXX} and that \red{XXX} test examples have scaled error of less than \red{XXX}. This is much worse than the corresponding number (\red{XXX}) for CNN1, indicating that strain based CNNs perform better than displacement based CNNs. The maximum and minimum shear moduli in the prediction are \red{XXX} and \red{XXX} as opposed to the true values of $5.0$ and $1.0$. 
% Losses for CNN2
\begin{figure}[!h]
  \centering
  \begin{subfigure}[c]{\nhghalfwidth}
...
\begin{figure}[!h]
  ...
  \begin{subfigure}[c]{\nhghalfwidth}
    \centering
    \includegraphics[totalheight=\nhgtotalheight]{Figures/dummy.png}
    \subcaption{\label{fig:cnn2resulta}Best}
  \end{subfigure}
  %
  \begin{subfigure}[c]{\nhghalfwidth}
    \centering
    \includegraphics[totalheight=\nhgtotalheight]{Figures/dummy.png}
    \subcaption{\label{fig:cnn2resultb}Worst}
  \end{subfigure}
  %
  \begin{subfigure}[c]{\nhghalfwidth}
    \centering
    \includegraphics[totalheight=\nhgtotalheight]{Figures/dummy.png}
    \subcaption{\label{fig:cnn2resultc}}
  \end{subfigure}
  %
  \begin{subfigure}[c]{\nhghalfwidth}
    \centering
    \includegraphics[totalheight=\nhgtotalheight]{Figures/dummy.png}
    \subcaption{\label{fig:cnn2resultd}}
  \end{subfigure}
...
In this section, we evaluate the ability of the CNN to generalize to examples outside its training set. As noted in table (\ref{table:cnnparams}) we train the CNN using data which was generated using only one inclusion. But we evaluate it on data containing one, two or three inclusions and see some ability to generalize.

Figure (\ref{fig:cnn3resulta}) shows accurate prediction of the shear modulus and location of the inclusion. This is not surprising because this example lies within the training space of the inclusion. In figure (\ref{fig:cnn3resultb}) the inclusion on the lower right is completely missed. The size of the inclusions on the upper left is severely under-predicted. In figures (\ref{fig:cnn3resultc}) and (\ref{fig:cnn3resultd}), we see the inclusions with higher shear modulus being accurately predicted and the inclusions with low shear modulus being predicted as wisps. However, in spite of being trained on data containing a single inclusion, the network detects two out of three inclusions. Figures (\ref{fig:cnn3resultc}) and (\ref{fig:cnn3resultd}) indicate that the network has some ability to generalize to unseen examples. Finally, we present additional results illustrating the performance of the network in figure (\ref{fig:app3result}) in Appendix (\ref{sect:appendix1}).

The training and validation losses for CNN3 are shown in figure (\ref{fig:cnn3losses}). The average inclusion scaled error is \red{XXX} and the average background scaled error is \red{XXX}. These indicate that, on average, the shear modulus of the inclusions is under-predicted, and that of the background is predicted accurately.

As described before in section (\ref{sect:resultscnn1}), figure (\ref{fig:cnn3histo}) shows histograms of the scaled error. We see that the examples appear to be normally distributed around a mean of \red{XXX} which is only slightly worse than CNN1 and the same as CNN2. The standard deviation is \red{XXX} which is significantly higher than CNN1 and CNN2. \red{XXX} examples have a scaled error less that \red{XXX}. This is much worse than the corresponding number for CNN1 (\red{XXX}) indicating that CNNs do not generalize perfectly. The maximum and minimum shear moduli in the prediction are \red{XXX} and \red{XXX} as opposed to the true values of $5.0$ and $1.0$.
...
\begin{figure}[!h]
  ...
  \begin{subfigure}[c]{\nhghalfwidth}
    \centering    
    \includegraphics[totalheight=\nhgtotalheight]{Figures/dummy.png}
    \subcaption{\label{fig:cnn3resulta}Best}
  \end{subfigure}
  %
  \begin{subfigure}[c]{\nhghalfwidth}
    \centering    
    \includegraphics[totalheight=\nhgtotalheight]{Figures/dummy.png}
    \subcaption{\label{fig:cnn3resultb}Worst}
  \end{subfigure}
  %
  \begin{subfigure}[c]{\nhghalfwidth}
    \centering
    \includegraphics[totalheight=\nhgtotalheight]{Figures/dummy.png}
    \subcaption{\label{fig:cnn3resultc}}
  \end{subfigure}
  %
  \begin{subfigure}[c]{\nhghalfwidth}
    \centering
    \includegraphics[totalheight=\nhgtotalheight]{Figures/dummy.png}
    \subcaption{\label{fig:cnn3resultd}}
  \end{subfigure}
...
\end{figure}
%
\subsection{\label{sect:lexample} L - shaped example}
...
\begin{table}
  ...
  \begin{tabular}{|c|c|c|}
    \hline
    \multirow{2}{*}{CNN Name} & Average        & Average inclusion \\
...
In this work, we have presented CNNs capable of predicting shear modulus fields from displacement or strain fields and obtained results that warrant further research. Slight under prediction of the inclusion shear modulus was seen. We used the twisted tanh function as the activation function of the output layer. We observed that with appropriate prior knowledge about the minimum and maximum shear modulus in the problem, the twisted tanh activation function reduces the incidence of 'haloes' (regions of low shear modulus) around the inclusions. The shear modulus of the inclusions with shear modulus close to the background modulus, or small inclusions, was predicted as wisps, while regions of high shear modulus were predicted more accurately.    
...
\item{We think that using millions of training examples may improve the performance of the CNNs evaluated in this work. Using a large number of examples may also help incorporate large ranges of $\mu$ and different boundary conditions. Highly optimized finite element solvers and supporting state of the art computer hardware such as high end clusters of CPUs and GPUs will be required. Fast hard disks will be required for handling large amounts of data.}
...
\begin{figure}[!h]
  ...
  \begin{subfigure}[c]{\nhgappwidth}
    ...
    \subcaption{\label{fig:app1resulta}}
  \end{subfigure}
  %
  \begin{subfigure}[c]{\nhgappwidth}
    \centering    
    \includegraphics[totalheight=\nhgappheight]{Figures/dummy.png}
    \subcaption{\label{fig:app1resultb}}
  \end{subfigure}
  %
  \begin{subfigure}[c]{\nhgappwidth}
    \centering
    \includegraphics[totalheight=\nhgappheight]{Figures/dummy.png}
    \subcaption{\label{fig:app1resultc}}
  \end{subfigure}
  %
  \begin{subfigure}[c]{\nhgappwidth}
    \centering
    \includegraphics[totalheight=\nhgappheight]{Figures/dummy.png}
    \subcaption{\label{fig:app1resultd}}
  \end{subfigure}
    \begin{subfigure}[c]{\nhgappwidth}
    \centering    
    \includegraphics[totalheight=\nhgappheight]{Figures/dummy.png}
    \subcaption{\label{fig:app1resulte}}
  \end{subfigure}
  %
  \begin{subfigure}[c]{\nhgappwidth}
    \centering    
    \includegraphics[totalheight=\nhgappheight]{Figures/dummy.png}
    \subcaption{\label{fig:app1resultf}}
  \end{subfigure}
  %
  \begin{subfigure}[c]{\nhgappwidth}
    \centering
    \includegraphics[totalheight=\nhgappheight]{Figures/dummy.png}
    \subcaption{\label{fig:app1resultg}}
  \end{subfigure}
  %
  \begin{subfigure}[c]{\nhgappwidth}
    \centering
    \includegraphics[totalheight=\nhgappheight]{Figures/dummy.png}
    \subcaption{\label{fig:app1resulth}}
  \end{subfigure}
\caption{\label{fig:app1result} Additional results for CNN1 in increasing order of the scaled error as defined in equation (\ref{eqn:scalederror}). True results are on the left and predictions on the right.}  
\end{figure}
%
...
\begin{figure}[!h]
  ...
  \begin{subfigure}[c]{\nhgappwidth}
    \centering    
    \includegraphics[totalheight=\nhgappheight]{Figures/dummy.png}
    \subcaption{\label{fig:app2resulta}}
  \end{subfigure}
  %
  \begin{subfigure}[c]{\nhgappwidth}
    \centering    
    \includegraphics[totalheight=\nhgappheight]{Figures/dummy.png}
    \subcaption{\label{fig:app2resultb}}
  \end{subfigure}
  %
  \begin{subfigure}[c]{\nhgappwidth}
    \centering
    \includegraphics[totalheight=\nhgappheight]{Figures/dummy.png}
    \subcaption{\label{fig:app2resultc}}
  \end{subfigure}
  %
  \begin{subfigure}[c]{\nhgappwidth}
    \centering
    \includegraphics[totalheight=\nhgappheight]{Figures/dummy.png}
    \subcaption{\label{fig:app2resultd}}
  \end{subfigure}
    \begin{subfigure}[c]{\nhgappwidth}
    \centering    
    \includegraphics[totalheight=\nhgappheight]{Figures/dummy.png}
    \subcaption{\label{fig:app2resulte}}
  \end{subfigure}
  %
  \begin{subfigure}[c]{\nhgappwidth}
    \centering    
    \includegraphics[totalheight=\nhgappheight]{Figures/dummy.png}
    \subcaption{\label{fig:app2resultf}}
  \end{subfigure}
  %
  \begin{subfigure}[c]{\nhgappwidth}
    \centering
    \includegraphics[totalheight=\nhgappheight]{Figures/dummy.png}
    \subcaption{\label{fig:app2resultg}}
  \end{subfigure}
  %
  \begin{subfigure}[c]{\nhgappwidth}
    \centering
    \includegraphics[totalheight=\nhgappheight]{Figures/dummy.png}
    \subcaption{\label{fig:app2resulth}}
  \end{subfigure}
\caption{\label{fig:app2result} Additional results for CNN2 in increasing order of the scaled error as defined in equation (\ref{eqn:scalederror}). True results are on the left and predictions on the right.}  
\end{figure}
%
...
\begin{figure}[!h]
  ...
  \end{subfigure}
\caption{\label{fig:app3result} Additional results for CNN3 in increasing order of the scaled error as defined in equation (\ref{eqn:scalederror}). True results are on the left and predictions on the right.}  
\end{figure}
%
\end{appendices}
\clearpage
