...
\section{Need to understand eqns 6.14-6.16}
...
\eeq
The equality holds only for $y=0$ or $y=1$, which are the values that $y$ is allowed to take. The $z$ that goes into $\sigma$ is called a logit.
\end{document}
%%% SO Question 1
