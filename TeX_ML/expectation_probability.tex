...
4. If $Z$ is uniformly distributed on $[0,1]$ as it is in a random number generator on a computed, we can do $X=F_X^{-1}(Z)$ to get a random variable $X$ distributed according to cdf $F_X$.
