...
But the thing is, the if you still want the eigenvectors in higher diemnsional space, you still need to explicitly know $\pmb{\phi}$ (equation 5). But the $\alpha_i$ in equation 5 can be solved usinga lower dimensional eigenproblem 7.
\end{document}
